...
function isHuaweiPhone(userAgentCustom) {
  ...
  const userAgentLowerCase =
    userAgentCustom.toLowerCase() || navigator.userAgent.toLowerCase();
...
function createQuickAppScript(callback) {
  ...
  const commonScriptUrl =
    "https://statres.quickapp.cn/quickapp/js/routerinline.min.js";
  const huaweiScriptUrl =
    "https://appimg.dbankcdn.com/hwmarket/files/fastapp/router.fastapp.js";
